...
import { setActiveAgentDefId } from "@/lib/ai/agent-defs";
...
function ModelSelectorOption({
  ...
  const handleSelect = useCallback(() => {
    ...
    // Keep the active agent definition in sync — the built-in Agent/Fast ids
    // match the built-in definition ids, so selecting here activates that
    // definition (custom definitions are managed from Agent settings).
    setActiveAgentDefId(model.id);
    setOpen(false);
    setTimeout(() => {
      document
